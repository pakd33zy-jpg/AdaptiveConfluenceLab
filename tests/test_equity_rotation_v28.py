...
MODULE_PATH = Path(__file__).resolve().parents[1] / "scripts" / "research_equity_rotation_v28.py"
spec = importlib.util.spec_from_file_location("equity_v28", MODULE_PATH)
...
def test_v28_core_anchor_configuration():
